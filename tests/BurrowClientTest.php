...
final class BurrowClientTest extends TestCase
{
    ...
    public function testStatamicPlatformFromLinkSetsStatamicAddonSourceOnPublish(): void
    {
        $transport = new QueueRecordingTransport([
            new HttpResponse(200, [
                'routing' => [],
        ...
        $client->link(new OnboardingLinkRequest(
            site: ['url' => 'https://statamic.test'],
            selection: ['organizationId' => 'org_123'],
            platform: 'statamic'
        ));

        $this->assertSame('statamic', $client->getState()->platform);
        ...
        $this->assertSame('statamic-addon', $transport->lastPayload['source'] ?? null);
    }
}
